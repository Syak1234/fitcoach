...
// class HealthService {
//   // Define health data types for Android
//   static final List<HealthDataType> dataTypesAndroid = [
...
//   // // Define health data types for iOS
...
//   // Getter to return platform-specific health data types
...
// // (Platform.isAndroid)
// //     ?
//       HealthService.dataTypesAndroid;
//   // : (Platform.isIOS)
//   //     ? dataTypesIOS
//   //     : [];
...
//     // Request permission to access location and Bluetooth for health data access
...
//     // If permissions are granted, check for health data access
...
//       if (stepsPermission) {
//         print("Steps permission granted!");
//       } else {
//         print("Steps permission denied!");
//       }
//     } else {
...
class _StepCounterScreenState extends State<StepCounterScreen> {
  ...
  void initState() {
    super.initState();
    _requestPermissionsAndFetchSteps();
  }

  /// Requests permission and fetches step count from Google Fit / Apple HealthKit
  Future<void> _requestPermissionsAndFetchSteps() async {
  ...
  Future<bool> _requestPermissions() async {
    ...
    if (status.isGranted) {
      ...
      bool healthAccess = await _health.requestAuthorization(types);
      return healthAccess;
    } else {
  ...
  Future<void> _fetchStepCount() async {
    ...
    List<HealthDataPoint> healthData = await _health.getHealthDataFromTypes(
        startTime: startOfDay, endTime: now, types: types);

    int totalSteps =
        healthData.fold(0, (sum, data) => sum + (data.value as int));
    print(totalSteps.toString());
    setState(() {
