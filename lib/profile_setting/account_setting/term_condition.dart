...
class _TermAndConditionState extends State<TermAndCondition> {
  RxString termAndCondition =
      "<center><p>Does not have any term & condition</p></center>".obs;
  ...
  callData() async {
    termAndCondition.value =
        await getInternalService(serviceName: 'Terms and Conditions');
    // termAndCondition.value = "";
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Obx(
          () => Column(
            ...
            mainAxisAlignment: termAndCondition.value == ""
            ...
            children: [
              getx.loadingWidget.value
                  ...
                  : getx.loadingWidget.value == false &&
                          termAndCondition.value == ""
                      ? Center(
                          child: Text("Does not have any term & condition"))
                      : HtmlWidget(termAndCondition.value),
            ],
          ),
        ),
      ),
